...
*	@date : 04-10-2015
*	Purpose: This class is a driver to test out an integer binary search tree.  It provides a menu and filters input for interaction with a tree, and a copy if prompted by the user.
*/
